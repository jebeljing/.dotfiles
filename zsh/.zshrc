...
alias aps="cd ~/code/approval_service"
alias mycode="cd ~/code"
alias cls="clear"
alias dot="cd ~/.dotfiles"
alias mux="tmuxinator start upstart"
alias dapi="umt dap interactive"
alias dapcreateprod="umt dap create -e upstart-web-prod -r 'jingshan' --exec"
alias dapexeprod="umt dap exec -e upstart-web-prod"
alias dapcreatestaging="umt dap create -e upstart-web-staging-1 -r 'jingshan' --exec"
alias dapexestaging="umt dap exec -e upstart-web-staging-1"
